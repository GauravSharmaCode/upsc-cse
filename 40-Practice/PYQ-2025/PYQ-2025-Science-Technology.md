---
tags: [pyq, 2025, science-technology]
...
> Source: UPSC CSE Prelims GS Paper-I, 25 May 2025 (Set B)
> Format: Question → Options → **Correct Answer ✅**
> Your task: Fill in **Why correct** for each answer.

---

## Q1. Alternative Powertrain Vehicles
...
## Q5. Coal Gasification Technology
...
## Q6. Military Explosives — CL-20, HMX, LLM-105

What is the common characteristic of the chemical substances CL-20, HMX and LLM-105?
...
- (a) Both Statement II and III correct and both explain Statement I
- **(b) Both Statement II and III correct but only one explains Statement I** ✅
...
## Q54. GAGAN Navigation System

GPS-Aided Geo Augmented Navigation (GAGAN) uses a system of ground stations. Which statements are correct?
...
- (a) Both correct and Statement II explains Statement I
- **(b) Both correct but Statement II does not explain Statement I** ✅
- (c) Statement I correct, Statement II not correct
- (d) Statement I not correct, Statement II correct
...
## Q62. Indian Railways — Kavach System
...
## Q63. Space Missions — Microgravity Research
...
## Q65. Cloud Seeding / Artificial Rainfall
