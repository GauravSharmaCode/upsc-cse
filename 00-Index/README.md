# UPSC CSE Prep - Knowledge Vault Index

> Central navigation hub for your UPSC preparation vault.
...
- **Static Notes**: Browse `10-Static/` for atomic topic notes
- **Current Affairs**: Check `20-Current-Affairs/` for date-prefixed CA
- **Templates**: Use `_templates/` for consistent note creation
- **Assets**: Find PDFs and images in `assets/`
